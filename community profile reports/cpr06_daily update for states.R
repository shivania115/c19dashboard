...
state_df_clean <- map_dfr(states_update,function(x) x[[1]])
state_date_range_clean <- map_dfr(states_update,function(x) x[[2]])
state_error_list <- map_dfr(states_update,function(x) x[[3]])
