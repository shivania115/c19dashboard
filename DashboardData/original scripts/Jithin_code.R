...
states_daterange_clean <- readRDS(paste0(path_c19dashboard_shared_folder,"/Data/Processed/Community Profile Reports/2021-03-30/states_date_range_clean.RDS"))
states_df_clean <- readRDS(paste0(path_c19dashboard_shared_folder,"/Data/Processed/Community Profile Reports/2021-03-30/states_df_clean.RDS"))
counties_daterange_clean <- readRDS(paste0(path_c19dashboard_shared_folder,"/Data/Processed/Community Profile Reports/2021-03-30/counties_date_range_clean.RDS"))
counties_df_clean <- readRDS(paste0(path_c19dashboard_shared_folder,"/Data/Processed/Community Profile Reports/2021-03-30/counties_df_clean.RDS"))
...
states_example_df<-states_example_df[,-c(1,4,6,13,14)]
...
counties_example_df<-counties_example_df[,-c(1,4,13,14)]
...
casesdata$Dist_Per_100K_new<-VaccineTracker0$Dist_Per_100K_new[VaccineTracker0$Date=="2021-03-31"]
casesdata$Dist_new<-VaccineTracker0$Dist_new[VaccineTracker0$Date=="2021-03-31"]
casesdata$distDate<-VaccineTracker0$distDate[VaccineTracker0$Date=="2021-03-31"]
